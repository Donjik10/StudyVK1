package io.mmaltsev.vkeducation.data
...
object AppDataProvider {
    fun getAppsListDto(): List<AppDto> = listOf(
        AppDto(
            name = "СберБанк Онлайн – с Салютом",
            developer = "Больше чем банк",
            category = CategoryDto.APP,
            ageRating = 0,
            size = 100f,
    ...
    fun getDefaultAppDto(): AppDto = getAppsListDto().last()
}