...
fun AppDetailsScreen(
    ...
    Column(modifier) {
        Toolbar(
            onBackClick = onBackClick,  // УБЕРИ лишний параметр onShareClick!
            onShareClick = {
...
private fun Preview() {
    VkEducationTheme {
        AppDetailsScreen(
            app = getPreviewApp(),  // Передаём app
            onBackClick = {},        // Передаём onBackClick
...
private fun getPreviewApp(): App = App(
    name = "Гильдия Героев: Экшен ММО РПГ",
    developer = "VK Play",
    category = Category.GAME,
    ageRating = 12,
